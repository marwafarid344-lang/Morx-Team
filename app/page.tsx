        ...
        <section id="features" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter">Everything You Need to Succeed</h2>
        ...
        <section id="testimonials" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter">Loved by Teams Worldwide</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
        ...
        <section id="pricing" className="w-full py-20 md:py-32 bg-muted/30 relative overflow-hidden">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter">Simple, Transparent Pricing</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
                    ...
                    {[
                      ...
                      >
                        ...
                        >
                          ...
                          <CardContent className="p-6 flex flex-col h-full">
                            <h3 className="text-2xl font-black italic tracking-tighter">{plan.name}</h3>
        ...
        <section id="faq" className="w-full py-20 md:py-32">
          <div className="container px-4 md:px-6">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter">Frequently Asked Questions</h2>
              <p className="max-w-[800px] text-muted-foreground md:text-lg">
